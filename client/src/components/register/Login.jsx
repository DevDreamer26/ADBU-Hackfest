...
export default function Login() {
  ...
  const handleUser = async (e) => {
    ...
    try {
      const res = await axios.post("http://localhost:8800/api/user/signin", { name, password },
        ...
        >
          ...
          <Box component="form" onSubmit={handleUser} noValidate sx={{ mt: 1 }}>
            <TextField
              ...
              required
              fullWidth
              id="name" // Use id attribute for correct labeling
              label="Username" // Use "Username" instead of "Email Address"
              name="name"
              autoComplete="name" // Use "username" for autoComplete
              autoFocus
